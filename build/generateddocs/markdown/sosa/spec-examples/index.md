  ...
  "@context": [
    {
      ...
      "equipment": "https://rdf.ag/o/equipment/",
      "ex": "https://example.org/data/",
      ...
      "sosa": "http://www.w3.org/ns/sosa/",
      "system": "http://www.w3.org/ns/ssn/systems/",
      "time": "http://www.w3.org/2006/time#",
...
### Example IBS-TH2-PLUS-capabilities.ttl
#### ttl
```ttl
@prefix ex: <https://example.org/data/> .
@prefix owl: <http://www.w3.org/2002/07/owl#> .
...
### Example InkBird-IBS-TH2-properties.ttl
#### ttl
```ttl
@prefix ex: <https://example.org/data/> .
@prefix qudt: <http://qudt.org/schema/qudt/> .
...
### Example InkBird-IBS-TH2-survivable-conditions.ttl
#### ttl
```ttl
@prefix ex: <https://example.org/data/> .
@prefix owl: <http://www.w3.org/2002/07/owl#> .
...
### Example PlannedObservationCollection.ttl
#### ttl
```ttl
@prefix ex: <https://example.org/data/> .
@prefix qk: <http://qudt.org/vocab/quantitykind/> .
...
### Example PlannedSampleCollection.ttl
#### ttl
```ttl
@prefix ex: <https://example.org/data/> .
@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> .
...
### Example UOM-qudt-collection.ttl
#### ttl
```ttl
@prefix ex: <https://example.org/data/> .
@prefix qk: <http://qudt.org/vocab/quantitykind/> .

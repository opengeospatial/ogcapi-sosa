...
## SOSA Actuator Feature

An Actuator is "a device that is used by, or implements, an (Actuating) Procedure that changes the state of the world." It is a specialisation of [System Properties](../system/), adding the `actsOn`/`isActedOnBy` relations to the Property it acts on.

This building block wraps [Actuator Properties](../../properties/actuator/) as a GeoJSON feature.

## Examples

### Example of a SOSA Actuator Feature (window closer)
From the SOSA/SSN specification's "apartment-134" example, as a GeoJSON feature.
#### json
```json
{
  "@id": "windowCloser_987",
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuator/context.jsonld",
  "@id": "windowCloser_987",
  "type": "Feature",
  "geometry": null,
  "properties": {
...
<https://example.org/data/apt134/windowCloser_987> a geojson:Feature ;
    sosa:actsOn <https://example.org/data/apt134/window_104_state> .
...
description: SOSA Actuator Feature
type: object
allOf:
...
- type: object
  properties:
    properties:
      $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/actuator/schema.yaml
      x-jsonld-id: '@nest'
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuator/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuator/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuator/context.jsonld)
...
* Path: `_sources/features/actuator`

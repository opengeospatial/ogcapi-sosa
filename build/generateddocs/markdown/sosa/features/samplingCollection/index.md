...
# SamplingCollection Feature (Schema)
...
## SOSA SamplingCollection Feature

This building block defines a GeoJSON FeatureCollection wrapping [SamplingCollection Properties](../../properties/samplingCollection/).

## Examples

### Example of a SOSA SamplingCollection Feature
The specification has no dedicated SamplingCollection example instance. This
extends the "LocatedSampling" example with a second sibling Sampling of the same
Feature of Interest, as a GeoJSON FeatureCollection. As with SampleCollection,
Sampling has no property that structurally distinguishes a leaf instance from a
nested collection, so members are expressed through `properties.hasMember`
rather than the `features` array, to avoid an ambiguous match.
#### json
```json
{
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/samplingCollection/context.jsonld",
  "type": "FeatureCollection",
  "properties": {
    "hasFeatureOfInterest": "EarthAtmosphere",
    "hasMember": [
...
<https://example.org/data/AirSampling_StE> sosa:hasResult <https://example.org/data/EarthAtmosphere_StE> ;
    sosa:resultTime "2024-06-01T09:00:00Z" .

<https://example.org/data/AirSampling_StE2> sosa:hasResult <https://example.org/data/EarthAtmosphere_StE2> ;
    sosa:resultTime "2024-06-01T09:15:00Z" .

[] a geojson:FeatureCollection ;
    sosa:hasFeatureOfInterest <https://example.org/data/EarthAtmosphere> ;
...
- type: object
  properties:
    properties:
      $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/samplingCollection/schema.yaml
      x-jsonld-id: '@nest'
    features:
      type: array
      items:
        oneOf:
        - $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sampling/schema.yaml
        - allOf:
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/samplingCollection/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/samplingCollection/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/samplingCollection/context.jsonld)
...
* Path: `_sources/features/samplingCollection`

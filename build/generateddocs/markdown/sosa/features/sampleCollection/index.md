...
# SampleCollection Feature (Schema)

`ogc.sosa.features.sampleCollection` *v1.0*
...
## SOSA SampleCollection Feature

This building block defines a GeoJSON FeatureCollection wrapping [SampleCollection Properties](../../properties/sampleCollection/).

## Examples

### Example of a nested SOSA SampleCollection Feature
From the SOSA/SSN specification's SampleCollection test dataset (SC1), as a GeoJSON
FeatureCollection. Unlike ObservationCollection, Sample/Sampling have no property
that structurally distinguishes a leaf instance from a nested collection (no
equivalent of Observation's required `hasResult`/`hasSimpleResult`), so nesting
here is expressed entirely through `properties.hasMember` rather than the
`features` array, to avoid an ambiguous match.
#### json
```json
{
  ...
  "properties": {
    ...
    "hasMember": [
      {
        "@id": "SC2",
        "isResultOfMadeBySampler": "http://orcid.org/0000-0002-3884-3420",
        "hasMember": [
          {
            "@id": "S2",
            "isResultOfUsedProcedure": "p5"
          },
          {
            "@id": "S3",
            "isResultOfUsedProcedure": "p6"
          }
        ]
      },
      {
        "@id": "SC3",
        "isResultOfMadeBySampler": "http://orcid.org/0000-0002-7815-2472",
        "hasMember": [
          {
            "@id": "S4",
            "isResultOfUsedProcedure": "p5"
...
<https://example.org/data/S2> sosa:isResultOfUsedProcedure <https://example.org/data/p5> .

<https://example.org/data/S3> sosa:isResultOfUsedProcedure <https://example.org/data/p6> .

<https://example.org/data/S4> sosa:isResultOfUsedProcedure <https://example.org/data/p5> .

<https://example.org/data/S5> sosa:isResultOfUsedProcedure <https://example.org/data/p6> .

<https://example.org/data/SC2> sosa:hasMember <https://example.org/data/S2>,
        <https://example.org/data/S3> ;
    sosa:isResultOfMadeBySampler <http://orcid.org/0000-0002-3884-3420> .

<https://example.org/data/SC3> sosa:hasMember <https://example.org/data/S4>,
        <https://example.org/data/S5> ;
    sosa:isResultOfMadeBySampler <http://orcid.org/0000-0002-7815-2472> .

[] a geojson:FeatureCollection ;
    sosa:hasMember <https://example.org/data/SC2>,
        <https://example.org/data/SC3> ;
    sosa:isSampleOf <https://example.org/data/foia> .
...
description: SOSA SampleCollection Feature
type: object
allOf:
...
- type: object
  properties:
    properties:
      $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampleCollection/schema.yaml
      x-jsonld-id: '@nest'
    features:
      type: array
      items:
        oneOf:
        - $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sample/schema.yaml
        - allOf:
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sampleCollection/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sampleCollection/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sampleCollection/context.jsonld)
...
* Path: `_sources/features/sampleCollection`

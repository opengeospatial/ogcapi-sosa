...
### Example of a SOSA Platform Feature
#### json
```json
{
  "@id": "platform-1",
  ...
  "geometry": null,
  "properties": {
    "hosts": ["https://example.com/sensor-1"]
  }
}
```
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/platform/context.jsonld",
  "@id": "platform-1",
  "type": "Feature",
  "geometry": null,
  "properties": {
    "hosts": [
      "https://example.com/sensor-1"
    ]
  }
}
```
...
<http://example.com/platform-1> a geojson:Feature ;
    sosa:hosts <https://example.com/sensor-1> .
...
description: SOSA Platform Feature
type: object
allOf:
- $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/asset/schema.yaml
- type: object
  properties:
    properties:
      $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/platform/schema.yaml
      x-jsonld-id: '@nest'
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/platform/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/platform/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/platform/context.jsonld)
...
* Path: `_sources/features/platform`

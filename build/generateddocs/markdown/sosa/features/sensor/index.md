...
This building block defines a GeoJSON feature wrapping [Sensor Properties](../../properties/sensor/).

## Examples

### Example of a SOSA Sensor Feature (located sensor)
From the SOSA/SSN specification's "LocatedSensor" example.
#### json
```json
{
  "@id": "IBS-TH2-56",
  ...
  "geometry": {
    "type": "Point",
    "coordinates": [-73.877244, 45.511672]
  },
  "properties": {}
}
```
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sensor/context.jsonld",
  "@id": "IBS-TH2-56",
  "type": "Feature",
  "geometry": {
    "type": "Point",
...
description: SOSA Sensor Feature
type: object
allOf:
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sensor/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sensor/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sensor/context.jsonld)

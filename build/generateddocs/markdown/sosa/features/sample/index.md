...
This building block defines a GeoJSON feature wrapping [Sample Properties](../../properties/sample/).

## Examples

### Example of a SOSA Sample Feature (air sample from Earth's atmosphere)
From the SOSA/SSN specification's "LocatedSample" example, as a GeoJSON feature.
#### json
```json
{
  "@id": "EarthAtmosphere_StE",
  "type": "Feature",
  "geometry": {
    "type": "Point",
  ...
  "properties": {
    "isSampleOf": "EarthAtmosphere",
    "isResultOf": "AirSampling_StE"
  }
}
```
...
<https://example.org/data/EarthAtmosphere_StE> a geojson:Feature ;
    sosa:isResultOf <https://example.org/data/AirSampling_StE> ;
    sosa:isSampleOf <https://example.org/data/EarthAtmosphere> ;
...
description: SOSA Sample Feature
type: object
allOf:
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sample/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sample/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sample/context.jsonld)

...
# Sampler Feature (Schema)

`ogc.sosa.features.sampler` *v1.0*
...
## SOSA Sampler Feature

A Sampler is "a device that is used by, or implements, a (Sampling) Procedure to create or transform one or more samples." It is a specialisation of [System Properties](../system/) with no additional properties of its own.

This building block wraps [Sampler Properties](../../properties/sampler/) as a GeoJSON feature.

## Examples

### Example of a SOSA Sampler Feature
From the SOSA/SSN specification's "PlannedDeployment" example, as a GeoJSON feature.
#### json
```json
{
  "@id": "SA56",
  ...
  "properties": {
    "implements": "Sp-A56",
    "isHostedBy": "LOIRE_A_JARGEAU_WQ_Station"
  }
}
```
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sampler/context.jsonld",
  "@id": "SA56",
  "type": "Feature",
  "geometry": null,
  "properties": {
...
<https://example.org/data/SA56> a geojson:Feature ;
    sosa:implements <https://example.org/data/Sp-A56> ;
    sosa:isHostedBy <https://example.org/data/LOIRE_A_JARGEAU_WQ_Station> .
...
description: SOSA Sampler Feature
type: object
allOf:
- $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/system/schema.yaml
- type: object
  properties:
    properties:
      $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampler/schema.yaml
      x-jsonld-id: '@nest'
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sampler/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sampler/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/sampler/context.jsonld)
...
* Path: `_sources/features/sampler`

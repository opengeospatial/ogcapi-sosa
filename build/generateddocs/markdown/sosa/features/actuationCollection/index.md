...
# ActuationCollection Feature (Schema)
...
### Example of a SOSA ActuationCollection Feature
The specification has no dedicated ActuationCollection example instance. This
extends the "open-window" Actuation example with a second sibling Actuation on
another window, sharing the same Actuator, as a GeoJSON FeatureCollection.
#### json
```json
{
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuationCollection/context.jsonld",
  "type": "FeatureCollection",
  "properties": {
    "madeByActuator": "closer-987"
  },
...
<https://example.org/data/open-window/A188> a geojson:Feature ;
    sosa:actsOnProperty <https://example.org/data/open-window/window98/openState> ;
    sosa:endTime "2017-04-18T17:24:00+02:00" ;
    sosa:hasSimpleResult true ;
    sosa:startTime "2017-04-18T17:23:00+02:00" .

<https://example.org/data/open-window/A189> a geojson:Feature ;
    sosa:actsOnProperty <https://example.org/data/open-window/window99/openState> ;
    sosa:endTime "2017-04-18T17:25:30+02:00" ;
    sosa:hasSimpleResult false ;
    sosa:startTime "2017-04-18T17:25:00+02:00" .

[] a geojson:FeatureCollection ;
    sosa:hasMember <https://example.org/data/open-window/A188>,
...
- type: object
  properties:
    properties:
      $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/actuationCollection/schema.yaml
      x-jsonld-id: '@nest'
    features:
      type: array
      items:
        oneOf:
        - $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuation/schema.yaml
        - allOf:
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuationCollection/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuationCollection/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/features/actuationCollection/context.jsonld)
...
* Path: `_sources/features/actuationCollection`

...
### Example of a SOSA Sample (air sample from Earth's atmosphere)
From the SOSA/SSN specification's "LocatedSampling" example - the Sample resulting
from a Sampling.
#### json
```json
{
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sample/context.jsonld",
  "@id": "EarthAtmosphere_StE",
  "isSampleOf": "EarthAtmosphere",
  "isResultOf": "AirSampling_StE"
}
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sample/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sample/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sample/context.jsonld)
...
* Path: `_sources/properties/sample`

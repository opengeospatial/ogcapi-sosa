...
# ActuationCollection Properties (Schema)

`ogc.sosa.properties.actuationCollection` *v1.0*
...
## SOSA ActuationCollection Properties

An ActuationCollection is a collection of one or more [Actuations](../actuation/), whose members share a common value for one or more properties - mirrors [ObservationCollection Properties](../observationCollection/) for Actuation.

## Examples

### Example of a SOSA ActuationCollection
The specification has no dedicated ActuationCollection example instance (only the
class declaration in the ontology). This extends the "open-window" Actuation
example with a second sibling Actuation on another window, sharing the same
Actuator, to demonstrate collection-level property inheritance.
#### json
```json
{
  "@id": "windowActuations",
  "madeByActuator": "closer-987",
  "hasMember": [
    {
      "@id": "A188",
      "actsOnProperty": "window98/openState",
      "hasSimpleResult": true,
      "startTime": "2017-04-18T17:23:00+02:00",
      "endTime": "2017-04-18T17:24:00+02:00"
    },
    {
      "@id": "A189",
      "actsOnProperty": "window99/openState",
      "hasSimpleResult": false,
      "startTime": "2017-04-18T17:25:00+02:00",
      "endTime": "2017-04-18T17:25:30+02:00"
    }
  ]
}
```
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/actuationCollection/context.jsonld",
  "@id": "windowActuations",
  "madeByActuator": "closer-987",
  "hasMember": [
    {
...
<https://example.org/data/open-window/windowActuations> sosa:hasMember <https://example.org/data/open-window/A188>,
        <https://example.org/data/open-window/A189> ;
    sosa:madeByActuator <https://example.org/data/open-window/closer-987> .

<https://example.org/data/open-window/A188> sosa:actsOnProperty <https://example.org/data/open-window/window98/openState> ;
    sosa:endTime "2017-04-18T17:24:00+02:00" ;
    sosa:hasSimpleResult true ;
    sosa:startTime "2017-04-18T17:23:00+02:00" .

<https://example.org/data/open-window/A189> sosa:actsOnProperty <https://example.org/data/open-window/window99/openState> ;
    sosa:endTime "2017-04-18T17:25:30+02:00" ;
    sosa:hasSimpleResult false ;
    sosa:startTime "2017-04-18T17:25:00+02:00" .
...
description: SOSA ActuationCollection
$defs:
  collection:
    allOf:
      ...
      properties:
        ...
        hasMember:
          ...
          items:
            anyOf:
            - $ref: '#/$defs/collection'
            - $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/actuation/schema.yaml
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/actuationCollection/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/actuationCollection/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/actuationCollection/context.jsonld)
...
* Path: `_sources/properties/actuationCollection`

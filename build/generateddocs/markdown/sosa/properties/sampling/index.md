...
# Sampling Properties (Schema)

`ogc.sosa.properties.sampling` *v1.0*
...
### Example of a SOSA Sampling (air sample from Earth's atmosphere)
From the SOSA/SSN specification's "LocatedSampling" example. The spec's own
illustration omits a `resultTime` (it focuses on geometry) and only asserts
`isResultOf` on the Sample, relying on inverse-property entailment for the
Sampling's own `hasResult` - both have been added explicitly here for a
complete, self-contained instance.
#### json
```json
{
  "@id": "AirSampling_StE",
...
ex:AirSampling_StE a sosa:Sampling ;
  ...
  sosa:hasResult ex:EarthAtmosphere_StE ;
  sosa:resultTime "2024-06-01T09:00:00Z"^^xsd:dateTime ;
.
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampling/context.jsonld",
  "@id": "AirSampling_StE",
  "hasFeatureOfInterest": "EarthAtmosphere",
  "hasInputValue": {
    "type": "Point",
...
description: SOSA Sampling
allOf:
- $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/execution/schema.yaml
- type: object
  properties:
    madeBySampler:
      type:
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampling/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampling/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampling/context.jsonld)
...
* Path: `_sources/properties/sampling`

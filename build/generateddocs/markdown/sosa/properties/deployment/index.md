...
## SOSA Deployment Properties

A Deployment is "the arrangement of one or more Assets (Systems and/or Platforms) to execute one or more Procedures with respect to designated Features of Interest, typically for a period of time."

`deployedOnPlatform` and `deployedSystem` are specialisations of `deployedAsset` for the common case of deploying a single Platform or System respectively.

## Examples

### Example of a SOSA Deployment
From the SOSA/SSN specification's "LocatedDeployment" example.
#### json
```json
{
  "@id": "TH2-56-2024",
  "deployedSystem": "IBS-TH2-56",
  "deployedOnPlatform": "Room31C",
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/deployment/context.jsonld",
  "@id": "TH2-56-2024",
  "deployedSystem": "IBS-TH2-56",
  "deployedOnPlatform": "Room31C",
  "startTime": "2024-01-01T00:00:00+00:00",
...
properties:
  ...
  startTime:
    type: string
    format: date-time
    x-jsonld-id: http://www.w3.org/ns/sosa/startTime
  endTime:
    type: string
    format: date-time
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/deployment/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/deployment/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/deployment/context.jsonld)
...
* Path: `_sources/properties/deployment`

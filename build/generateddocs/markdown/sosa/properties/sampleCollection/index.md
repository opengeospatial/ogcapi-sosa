...
# SampleCollection Properties (Schema)

`ogc.sosa.properties.sampleCollection` *v1.0*
...
## SOSA SampleCollection Properties

A SampleCollection is a collection of one or more [Samples](../sample/), whose members share a common value for one or more properties.

## Examples

### Example of a nested SOSA SampleCollection
From the SOSA/SSN specification's SampleCollection test dataset (SC1): a top-level
collection of two sub-collections (one per Sampler used), each holding two Samples
that share a common Procedure. `isResultOfMadeBySampler`/`isResultOfUsedProcedure`
are held at the level of the (sub-)collection that shares them, per the same
property-inheritance pattern used by ObservationCollection.
#### json
```json
{
  "@id": "SC1",
...
.
ex:S2 a sosa:Sample ; sosa:isResultOfUsedProcedure ex:p5 .
ex:S3 a sosa:Sample ; sosa:isResultOfUsedProcedure ex:p6 .
ex:S4 a sosa:Sample ; sosa:isResultOfUsedProcedure ex:p5 .
ex:S5 a sosa:Sample ; sosa:isResultOfUsedProcedure ex:p6 .
ex:foia a sosa:FeatureOfInterest .
orcid:0000-0002-3884-3420 a sosa:Sampler .
orcid:0000-0002-7815-2472 a sosa:Sampler .
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampleCollection/context.jsonld",
  "@id": "SC1",
  "isSampleOf": "foia",
  "hasMember": [
    {
...
description: SOSA SampleCollection
$defs:
  oneOrMany:
    oneOf:
    - type:
    ...
    properties:
      ...
      hasMember:
        ...
        items:
          anyOf:
          - $ref: '#/$defs/collection'
          - $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sample/schema.yaml
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampleCollection/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampleCollection/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampleCollection/context.jsonld)
...
* Path: `_sources/properties/sampleCollection`

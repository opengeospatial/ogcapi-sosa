...
# Sampler Properties (Schema)

`ogc.sosa.properties.sampler` *v1.0*
...
### Example of a SOSA Sampler
From the SOSA/SSN specification's "PlannedDeployment" example: Sampler SA56
implements a sampling Procedure and is hosted on a water-quality station.
#### json
```json
{
  "@id": "SA56",
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampler/context.jsonld",
  "@id": "SA56",
  "implements": "Sp-A56",
  "isHostedBy": "LOIRE_A_JARGEAU_WQ_Station"
}
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampler/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampler/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampler/context.jsonld)
...
* Path: `_sources/properties/sampler`

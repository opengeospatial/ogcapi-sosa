...
# SamplingCollection Properties (Schema)

`ogc.sosa.properties.samplingCollection` *v1.0*
...
## SOSA SamplingCollection Properties

A SamplingCollection is a collection of one or more [Samplings](../sampling/), whose members share a common value for one or more properties - mirrors [ObservationCollection Properties](../observationCollection/) for Sampling.

## Examples

### Example of a SOSA SamplingCollection
The specification has no dedicated SamplingCollection example instance (only the
class declaration in the ontology). This extends the "LocatedSampling" example
with a second sibling Sampling of the same Feature of Interest, to demonstrate
collection-level property inheritance.
#### json
```json
{
  "@id": "atmosphereSamplings",
  ...
  "hasMember": [
    {
      ...
      "hasInputValue": {
        "type": "Point",
        "coordinates": [4.387611, 45.437772]
      },
      "hasResult": "EarthAtmosphere_StE",
      "resultTime": "2024-06-01T09:00:00Z"
    },
    {
      "@id": "AirSampling_StE2",
      "hasInputValue": {
        "type": "Point",
        "coordinates": [4.388, 45.438]
      },
      "hasResult": "EarthAtmosphere_StE2",
      "resultTime": "2024-06-01T09:15:00Z"
    }
  ]
}
```
...
```jsonld
{
  "@context": "https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/samplingCollection/context.jsonld",
  "@id": "atmosphereSamplings",
  "hasFeatureOfInterest": "EarthAtmosphere",
  "hasMember": [
    {
...
<https://example.org/data/atmosphereSamplings> sosa:hasFeatureOfInterest <https://example.org/data/EarthAtmosphere> ;
    sosa:hasMember <https://example.org/data/AirSampling_StE>,
        <https://example.org/data/AirSampling_StE2> .

<https://example.org/data/AirSampling_StE> sosa:hasInputValue [ ] ;
    sosa:hasResult <https://example.org/data/EarthAtmosphere_StE> ;
    sosa:resultTime "2024-06-01T09:00:00Z" .

<https://example.org/data/AirSampling_StE2> sosa:hasInputValue [ ] ;
    sosa:hasResult <https://example.org/data/EarthAtmosphere_StE2> ;
    sosa:resultTime "2024-06-01T09:15:00Z" .
...
description: SOSA SamplingCollection
$defs:
  collection:
    allOf:
      ...
      properties:
        ...
        hasMember:
          ...
          items:
            anyOf:
            - $ref: '#/$defs/collection'
            - $ref: https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/sampling/schema.yaml
...
* YAML version: [schema.yaml](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/samplingCollection/schema.json)
* JSON version: [schema.json](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/samplingCollection/schema.yaml)
...
[context.jsonld](https://opengeospatial.github.io/ogcapi-sosa/build/annotated/sosa/properties/samplingCollection/context.jsonld)
...
* Path: `_sources/properties/samplingCollection`

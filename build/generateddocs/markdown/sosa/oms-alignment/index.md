...
# Alignment with ISO 19156 (OMS) (Clause)

`ogc.sosa.oms-alignment` *v1.0*
...
* [OGC Abstract Specification Topic 20 - Observations, Measurements and Samples (O&M 3.0)](https://www.ogc.org/standards/om/)
* [Semantic Sensor Network Ontology - 2023 Edition (SOSA/SSN 2.0)](https://www.w3.org/TR/vocab-ssn-2023/)
* [SOSA-OMS extension module (sosa-oms.ttl)](https://github.com/w3c/sdw-sosa-ssn/blob/gh-pages/ssn/rdf/ontology/extensions/sosa-oms.ttl)
